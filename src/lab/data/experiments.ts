...
export const EXPERIMENTS: Experiment[] = [
  ...
  {
    id: 'potassium-permanganate-reduction',
    title: 'Potassium Permanganate Reduction Reaction',
    description: 'Observe the reduction of purple potassium permanganate in acidic medium to pale pink Mn²⁺.',
    difficulty: 'beginner',
    duration: 10,
    category: 'redox',
    objectives: [
    ...
    steps: [
      {
        id: 'step1',
        instruction: 'Add potassium permanganate solution to test tube',
        equipment: ['test-tube'],
        chemicals: ['kmno4'],
        action: 'pour',
        expectedObservation: 'Test tube fills with purple solution',
        completed: false
      },
      {
        id: 'step2',
      ...
      {
        id: 'step3',
        instruction: 'Add reducing agent',
        equipment: ['graduated-cylinder'],
        chemicals: ['oxalic-acid'],
        action: 'pour',
        expectedObservation: 'Solution should fade from purple → pale pink slowly (6–10 sec)',
        completed: false
      }
    ],
    safetyNotes: [
    ...
    expectedResults: [
      ...
      'Smooth color transition over 6-10 seconds',
        ...
        effects: [
          {
            type: 'color-change',
            intensity: 1.0,
            duration: 10000, // 10 seconds for full transition
            color: '#FFF5FA' // Final color: almost colorless
          }
        ]
      }
    ]
