...
export function generateReactionLogic(experiments: Experiment[]): ReactionLogic {
  ...
  experiments.forEach(experiment => {
    ...
    // Special case for Potassium Permanganate Reduction Reaction
    if (experiment.id === 'potassium-permanganate-reduction') {
      // Add a special reaction for the Potassium Permanganate Reduction Reaction effect
      const potassiumPermanganateReductionKey = `${experiment.id}-reduction`
      reactionLogic[potassiumPermanganateReductionKey] = {
      ...
      console.log('🧪 Added Potassium Permanganate Reduction Reaction:', potassiumPermanganateReductionKey)
    }
